...
SpectralAnalysis::SpectralAnalysis(neutrino *nparent) : nGenericPan(nparent)
{
    my_w.setupUi(this);
...
void SpectralAnalysis::on_direction_toggled(bool val) {
...
void SpectralAnalysis::on_calculate_released() {
    saveDefaults();
